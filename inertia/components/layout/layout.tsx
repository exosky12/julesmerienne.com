...
export const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 h-full w-3/4 max-w-xs bg-white shadow-xl transition-transform duration-300 ease-out p-6 flex flex-col gap-6 ${open ? 'translate-x-0' : 'translate-x-full'}`}
      >
